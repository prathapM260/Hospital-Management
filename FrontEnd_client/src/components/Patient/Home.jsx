...
function Home() {
  ...
  return (
    // <div className='bg-gradient-to-b from-primary via-[#ffffff] to-white z-500'   >
    // <div className="bg-gradient-to-r from-[#def3fb] via-[#ffffff] to-primary z-500">
    // <div className="bg-gradient-to-r from-[#def3fb] via-[#ffffff] to-[#def3fb] z-500">
<div className="h-screen w-screen bg-gradient-to-r from-[#def3fb] to-white to-65%">
